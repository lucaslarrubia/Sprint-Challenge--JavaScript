...
const universities = [graduates[2]];
...
const animalNames = [];
    ...
    animalNames.push(`Name: ${array.animal_name} Scientific: ${array.scientific_name}`);
  })
...
const lowerCase = [];
  zooAnimals.map((animals, index) => {
    lowerCase[index] = animals.animal_name.toLowerCase();
  })
